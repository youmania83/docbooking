    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-sm font-semibold text-blue-700">Now Live in Panipat</span>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mt-16 pt-16 border-t border-gray-200">
          <div className="flex items-center justify-center gap-3 bg-blue-50 rounded-xl p-6 w-full text-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Join verified medical professionals who trust DocBooking
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400">info@docbooking.in</p>
            </div>
          </div>
